        ...
        <el-row>
          ...
          <el-col :span="6" >
            <el-form-item label="合同状态：" prop="conStatus">
              <el-select v-model="contractDetails['conStatus']" disabled style="width:85%">
                <el-option
                  v-for="(item,key) in conStatusArr"
                  :disabled="!canEdit"
                  :key="key"
                  :label="item.label"
                  :value="item.value"/>
        ...
        <el-row>
          <el-col :span="6" >
            <el-form-item label="设备供应商：">
              <el-input v-model="contractDetails['supplier']" :readonly = "!canEdit" style="width:85%"/>
            </el-form-item>
          </el-col>
          <el-col :span="6" >
            <el-form-item label="维保单位：" prop="maintDep">
              <el-input v-model="contractDetails['maintDep']" :readonly = "!canEdit" style="width:85%"/>
            </el-form-item>
          </el-col>
          <el-col :span="6" >
          ...
          <el-col :span="6">
            <el-form-item label="维保联系人电话：" prop="maintPhone">
          ...
          <el-col :span="8">
            <el-form-item label="问卷名称：" prop="queName">
              <el-input
                ...
                style="width:85%"
              >
                <SelectQuestionDialog slot="append" :con-type="conType" :can-edit="canEdit" :select-callback="selectHandler"/>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6" >
  ...
  data() {
    ...
    return {
      ...
      formRule: {
        ...
        maintPeople: [
          { required: true, message: '请输入维保联系人' }
        ],
        maintPhone: [
