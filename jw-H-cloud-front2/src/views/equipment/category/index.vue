              ...
              >
                <template slot-scope="{row}">
                  <el-button
                    ...
                    size="mini"
                    type="primary"
                    @click="$router.push('edit/' + row['eqTypeId'])">编辑</el-button>
                  <el-button
                    :disabled="isOperating"
                    size="mini"
                    type="danger"
                    @click="deleteAlarmType(row['eqTypeId'],row['eqStd'])">删除</el-button>
                </template>
              </el-table-column>
            </el-table>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    async deleteAlarmType(eqTypeId, eqStd) {
      ...
      try {
        ...
        await deleteEquipmentCategoryData(body)
        this.$message({
          message: `删除成功！`,
          type: 'success'
        })
